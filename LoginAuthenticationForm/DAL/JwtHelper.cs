...
namespace LoginAuthenticationForm.DAL
{
    public static class JwtHelper
    {
        public static IEnumerable<Claim> GetClaims( this UserTokens userAccout, Guid Id)
        {
            IEnumerable<Claim> claims = new Claim[] {
                new Claim("Id", userAccout.Id.ToString()),
                    new Claim(ClaimTypes.Name, userAccout.UserName),
                    new Claim(ClaimTypes.Email, userAccout.EmailId),
        ...
        public static UserTokens GetUserTokens(UserTokens model, JwtSettings jwtSettings)
        {
            try
            {
